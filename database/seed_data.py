        ...
        if Usuario.query.count() == 0:
            usuarios = [
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed45"),
                    celular="987654324",
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed56"),
                    celular="987654325",
                ...
                Usuario(
                    ...
                    apellido="Martínez",
                    email="ana@email.com",
                    contrasena_hash=generate_password_hash("Hashed67"),
                    celular="987654326",
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed78"),
                    celular="987654327",
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed89"),
                    celular="987654328",
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed01"),
                    celular="987654330",
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed11"),
                    celular="987654331",
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed22"),
                    celular="987654332",
                ...
                Usuario(
                    ...
                    contrasena_hash=generate_password_hash("Hashed33"),
                    celular="987654333",
